                    ...
                    <table class="table table-bordered mb-0">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th wire:click.prevent="sortBy('weight')" class="text-center cursor-pointer"
                                    scope="col">Weight
                                    <x-sort-indicator field="weight" :sortField="$sortField" :sortDirection="$sortDirection" />
                                </th>
                                    ...
                                    <td class="text-center w-1-perc">
                                        <button wire:click="toggleActive({{ $attribute->id }})"
                                            ...
                                            <span class="btn-inner--icon"><i
                                                    class="fas {{ $attribute->is_active ? 'fa-check' : 'fas fa-times' }} fa-lg"></i></span>
                                        </button>
                                    </td>
