    ...
    <div class="container-fluid py-4">
        ...
        <form method="POST"
            ...
            <div class="row mt-4 justify-content-center">
                <div class="col-auto">
                    <button type="submit"
                        class="btn btn-success btn-sm px-4 shadow-none">{{ $productCategory->id ? 'Update' : 'Save' }}</button>
                </div>
                <div class="col-auto">
                    <a href="{{ route('admin.product-categories.index') }}" class="btn btn-info btn-sm px-4 shadow-none">Go
                        back</a>
                </div>
            </div>
        </form>
